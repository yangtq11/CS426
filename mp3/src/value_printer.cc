...
{
	o << "@" + name + " = " + (op.is_internal() ? "internal " : "") + "constant " + op.get_typename() + " ";
...
{
	check_ostream(o);
	o << "\tstore " + op.get_typename() + " " + op.get_name() + ", " + result.get_typename() + " " + result.get_name() + "\n";
}
...
void ValuePrinter::getelementptr(ostream &o, op_type type, operand op1, operand op2, operand op3, operand result)
{
	...
	if (result.get_type().get_id() != VOID)
		o << result.get_name() << " = ";
	o << "getelementptr " + type.get_name() + ", " + op1.get_typename() + " " + op1.get_name() + ", " + op2.get_typename() + " " + op2.get_name() + ", " + op3.get_typename() + " " + op3.get_name() + "\n";
}
...
void ValuePrinter::getelementptr(ostream &o, op_type type, operand op1, operand op2, operand result)
{
	...
	if (result.get_type().get_id() != VOID)
		o << result.get_name() << " = ";
	o << "getelementptr " + type.get_name() + ", " + op1.get_typename() + " " + op1.get_name() + ", " + op2.get_typename() + " " + op2.get_name() + "\n";
}
...
void ValuePrinter::getelementptr(ostream &o, op_type type, operand op1, operand op2, operand op3, operand op4, operand result)
{
	...
	if (result.get_type().get_id() != VOID)
		o << result.get_name() << " = ";
	o << "getelementptr " + type.get_name() + ", " + op1.get_typename() + " " + op1.get_name() + ", " + op2.get_typename() + " " + op2.get_name() + ", " + op3.get_typename() + " " + op3.get_name() + ", " + op4.get_typename() + " " + op4.get_name() + "\n";
}
...
void ValuePrinter::getelementptr(ostream &o, op_type type, operand op1, operand op2, operand op3, operand op4, operand op5, operand result)
{
	...
	if (result.get_type().get_id() != VOID)
		o << result.get_name() << " = ";
	o << "getelementptr " + type.get_name() + ", " + op1.get_typename() + " " + op1.get_name() + ", " + op2.get_typename() + " " + op2.get_name() + ", " + op3.get_typename() + " " + op3.get_name() + ", " + op4.get_typename() + " " + op4.get_name() + ", " + op5.get_typename() + " " + op5.get_name() + "\n";
}
...
{
	check_ostream(o);
	o << "\t" + result.get_name() + " = select " + op1.get_typename() + " " + op1.get_name() + ", " + op2.get_typename() + " " + op2.get_name() + ", " + op3.get_typename() + " " + op3.get_name() + "\n";
}
...
{
	check_ostream(o);
	o << "\tbr " + op.get_typename() + " " + op.get_name() + ", label %" + label_true + ", label %" + label_false + "\n";
}
